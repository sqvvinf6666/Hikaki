...
BOT_USERNAME = "SeendChekBot"  # Додано правильне ім'я бота
...
""",
        "profile_caption": (
            ...
            "https://t.me/@SeendChekBot?start=ref_{user_id}\n\n"
            "📊 Статистика\n"
            "📦 Успешных заказов: 0\n"
            "⭐️ Куплено звёзд: 0"
        ),
        "terms_caption": (
            "Условия использования @SeendChekBot:\n\n"
            ...
            "С уважением, команда @SeendChekBot."
        ),
        "stars_caption": (
            ...
            "4. ✍️ Введите имя бота @SeendChekBot и нажмите Добавить.\n"
        ...
        "check_result": (
            ...
            "Спасибо за использование @SeendChekBot!"
        ),
